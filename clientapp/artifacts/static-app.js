...
function App() {
  return external_react_default.a.createElement(external_react_static_["Root"], null, external_react_default.a.createElement("nav", null, external_react_default.a.createElement(Router["a" /* Link */], {
    to: "/"
  }, "Whitefriars Sailing Club"), external_react_default.a.createElement(Router["a" /* Link */], {
    to: "/"
  }, "Home"), external_react_default.a.createElement(Router["a" /* Link */], {
    to: "/enter race"
  }, "Enter Race"), external_react_default.a.createElement(Router["a" /* Link */], {
    to: "/blog"
...
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(30));
...
var t_2 = C_Users_Luke_source_repos_serverless_sailingweb_clientapp_node_modules_react_universal_component_dist_index_js__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "../src/pages/enter race.js",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | src/pages/enter race */).then(__webpack_require__.bind(null, 24))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '../src/pages/enter race.js');
  },
  resolve: function resolve() {
    return /*require.resolve*/(24);
  },
  chunkName: function chunkName() {
    return "src/pages/enter race";
  }
}), universalOptions);
...
var _objectSpread2 = _interopRequireDefault(__webpack_require__(33));
...
var _staticInfoContext = _interopRequireDefault(__webpack_require__(48));
